...
Partial Public Class Database1DataSet
    ...
    Partial Public Class tblitemsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddtblitemsRow(ByVal itemname As String, ByVal category As String, ByVal qty As Decimal) As tblitemsRow
            Dim rowtblitemsRow As tblitemsRow = CType(Me.NewRow,tblitemsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, itemname, category, qty}
...
Namespace Database1DataSetTableAdapters
    ...
    Partial Public Class tblitemsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [tblitems] ([itemname], [category], [qty]) VALUES (@itemname, @catego"& _ 
                "ry, @qty)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [tblitems] SET [itemname] = @itemname, [category] = @category, [qty] = @qt"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Search_and_Filter_using_Local_DB.My.MySettings.Default.Database1ConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [id], [itemname], [category], [qty] FROM [tblitems]"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlServerCe.SqlCeCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT [id], [itemname], [category], [qty] FROM [tblitems]" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE [category] = ?"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@Param1", Global.System.Data.SqlDbType.NVarChar, 100, Global.System.Data.ParameterDirection.Input, True, 0, 0, "category", Global.System.Data.DataRowVersion.Current, Nothing))
            Me._commandCollection(2) = New Global.System.Data.SqlServerCe.SqlCeCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT [id], [itemname], [category], [qty] FROM [tblitems]" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE [itemname] LIKE" & _
                " ?"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.SqlServerCe.SqlCeParameter("@Param1", Global.System.Data.SqlDbType.NVarChar, 100, Global.System.Data.ParameterDirection.Input, True, 0, 0, "itemname", Global.System.Data.DataRowVersion.Current, Nothing))
        End Sub
        ...
        Public Overridable Overloads Function FilterData(ByVal dataTable As Database1DataSet.tblitemsDataTable, ByVal Param1 As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], False)> _
        Public Overridable Overloads Function GetDataBy1(ByVal Param1 As String) As Database1DataSet.tblitemsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (Param1 Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal itemname As String, ByVal category As String, ByVal qty As Global.System.Nullable(Of Decimal)) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal itemname As String, ByVal category As String, ByVal qty As Global.System.Nullable(Of Decimal), ByVal Original_id As Integer) As Integer
            If (itemname Is Nothing) Then
